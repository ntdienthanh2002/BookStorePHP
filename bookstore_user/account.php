                                            ...
                                            <div class="coron_table table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $uid = $_SESSION['uid'];
                                                        $stmt = $conn->prepare("SELECT dh_ma, dh_ngaydathang, dh_ngaygiaohang FROM donhang WHERE tknd_ma = $uid");
                                                        $stmt->execute();
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="order-detail.php?action=vieworder&id=<?php echo $row['dh_ma'] ?>" class="view">Xem</a></td>
                                                            </tr>
                                                        <?php }
                                                        ?>
                                                    </tbody>
