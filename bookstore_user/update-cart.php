                                    ...
                                    <div class="table_desc">
                                        <div class="cart_page table-responsive">
                                            <table>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $stmt = $conn->prepare("select sp_ma, sp_ten from sanpham where sp_ma = $id");
                                                    $stmt->execute();
                                                    $result = $stmt->get_result()->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td class="product_name"><?php echo $result['sp_ten'] ?></td>
                                                        <td class="product_quantity"><input type="number" name="quantity" min="1" max="<?php echo $result['sp_soluongtonkho'] ?>"></td>
                                                    </tr>
                                        ...
                                        <div class="cart_submit">
                                            <button type="submit" name="change">Cập nhật</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
