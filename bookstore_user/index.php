                ...
                <div class="pos_page_inner">
                    ...
                    <div class="pos_home_section">
                                ...
                                <div class="banner_slider slider_two">
                                    <div class="slider_active owl-carousel">
                                        <div class="single_slider"
                                             style="background-image: url(assets/img/banner/banner.jpg)">
                                            <div class="slider_content">
                                                <div class="slider_content_inner">
                                                    <h1>Sách</h1>
                                                    <p>Kho tàng kiến thức vô tận</p>
                                                    <br><br>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="new_product_area product_two">
                            ...
                            <?php
                            $product = new Sanpham("", "");
                            $result = $product->showProductsNew($conn);
                            if ($result->num_rows > 0) {
                                ?>
                                <div class="row">
                        ...
                        <div class="new_product_area product_two">
                            ...
                            <?php
                            $product = new Sanpham("", "");
                            $result = $product->showProductsSale($conn);
                            if ($result->num_rows > 0) {
                                ?>
                                <div class="row">
                                    <div class="single_p_active owl-carousel">
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb single_banner">
                                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($row['sp_hinhanh']) ?>" alt="">
                                                        <div class="product_action">
                                                            <a href="cart.php?action=add&id=<?php echo $row['sp_ma'] ?>"> <i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
                                                        </div>
                                                        <div class="banner_title">
                                                            <p>Giảm <span> <?php echo $row['sp_giamgia'] ?> %</span></p>
                                                        </div>
                                                    </div>
                                                    <div class="product_content">
                                                        <span class="product_price"><?php echo number_format($row['sp_gia'], 0, '', ',') ?> đ</span>
                        ...
                        <div class="new_product_area product_two">
                            ...
                            <?php
                            $product = new Sanpham("", "");
                            $result = $product->showProductsHot($conn);
                            if ($result->num_rows > 0) {
                                ?>
                                <div class="row">
                                    <div class="single_p_active owl-carousel">
