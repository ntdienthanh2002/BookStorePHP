                        ...
                        <div class="shop_tab_product shop_fullwidth">   
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="large" role="tabpanel">
                                    <?php
                                    $stmt = $conn->prepare("SELECT sp_ma, sp_ten, sp_hinhanh, sp_gia, tg_ma FROM sanpham WHERE sp_ten LIKE '%$search%'");
                                    $stmt->execute();
                                    ...
                                    if ($result->num_rows > 0) {
                                                    ...
                                                    <div class="single_product">
                                                        <div class="product_thumb">
                                                            ...
                                                            <div class="product_action">
                                                                <a href="display-products.php?action=add&id=<?php echo $row['sp_ma'] ?>"> <i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
                                                            </div>
                                                        </div>
                                        ...
                                        ?>
                                        <p>Hiện chưa có sản phẩm bạn cần tìm.<p>
                                        <?php } ?>
                                </div>
                            </div>
                        </div>    
