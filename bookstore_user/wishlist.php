    ...
    if (isset($_SESSION['uid'])) {
        ...
        if (isset($_SESSION['wish'][$id])) {
            ...
            if (isset($result['sp_ma']) && $result['sp_ma']) {
                $_SESSION['wish'][$result['sp_ma']] = array("quantity" => 1, "price" => $result['sp_gia']);
            } else {
                                    ...
                                    <div class="table_desc wishlist">
                                        <div class="cart_page table-responsive">
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th class="product_remove">Xóa yêu thích</th>
                                                        <th class="product_name">Tên sản phẩm</th>
                                                        <th class="product-price">Giá</th>
                                                        <th class="product_quantity">Hiện còn</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_SESSION['wish'])) {
                                                        ...
                                                        $stmt = $conn->prepare("select sp_ma, sp_ten, sp_gia, sp_soluongtonkho from sanpham where sp_ma in ($strIds)");
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        while ($row = $result->fetch_assoc()) {
                                                            ?>
                                                            <tr>
                                                                <td class="product_remove"><a href="?action=remove&id=<?php echo $row['sp_ma'] ?>">X</a></td>
                                                                <td class="product_name"><?php echo $row['sp_ten'] ?></td>
                                                                <td class="product-price"><?php echo number_format($row['sp_gia'], 0, '', ',') ?> đ</td>
                                                                <td class="product_quantity"><?php echo $row['sp_soluongtonkho'] ?></td>
                                                                <td class="product_total"><a href="cart.php?action=add&id=<?php echo $row['sp_ma'] ?>">Thêm vào giỏ hàng</a></td>
                                                            </tr>
                                                        <?php }
                                                        ?>
