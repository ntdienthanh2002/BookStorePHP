                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Thêm nhà xuất bản</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <input name="namepu" type="text" class="form-control" placeholder="Tên nhà xuất bản">
                                                                        <?php
                                                                        if (isset($_POST['add'])) {
                                                                            ...
                                                                            if ($publishing != "") {
                                                                                ...
                                                                                if ($result->num_rows > 0) {
                                                                                    ...
                                                                                    $sql = "INSERT INTO nhaxuatban (nxb_ten) VALUES ('$publishing')";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Thêm nhà xuất bản mới thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Thêm nhà xuất bản thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
                                                                                ?>
                                                                                <span>Vui lòng nhập nhà xuất bản.</span>
                                                                                <?php
                                                                            }
                                                                        }
                                                                        ?>
