                                        ...
                                        <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="addr">Địa chỉ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $user = new Taikhoannguoidung("", "");
                                                $result = $user->showAllUsers($conn);
                                                while ($row = $result->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $row['tknd_ma'] ?></td>
                                                        <td><?php echo $row['tknd_tendangnhap'] ?></td>
                                                        <td><?php echo $row['tknd_email'] ?></td>
                                                        <td><?php echo $row['tknd_sodienthoai'] ?></td>
                                                        <td><?php echo $row['tknd_diachi'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
