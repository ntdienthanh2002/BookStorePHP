                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Thêm tác giả</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <input name="nameau" type="text" class="form-control" placeholder="Tên tác giả">
                                                                        <?php
                                                                        if (isset($_POST['add'])) {
                                                                            ...
                                                                            if ($author != "") {
                                                                                ...
                                                                                if ($result->num_rows > 0) {
                                                                                    ...
                                                                                    $sql = "INSERT INTO tacgia (tg_ten) VALUES ('$author')";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Thêm tác giả mới thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Thêm tác giả mới thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
                                                                                ?>
                                                                                <span>Vui lòng nhập tác giả.</span>
                                                                                <?php
                                                                            }
                                                                        }
                                                                        ?>
