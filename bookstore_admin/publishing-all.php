                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th data-field="state">Cập nhật</th>
                                                    <th data-field="id">Mã</th>
                                                    <th data-field="name">Tên nhà xuất bản</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $publishing = new Nhaxuatban("", "");
                                                $result = $publishing->showAllPublishing($conn);
                                                while ($row = $result->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td><a href="publishing-update.php?action=update&idpu=<?php echo $row['nxb_ma'] ?>"><i class="fa fa-edit"></i></a></td>
                                                        <td><?php echo $row['nxb_ma'] ?></td>
                                                        <td><?php echo $row['nxb_ten'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
