                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Cập nhật sản phẩm</a></li>
                                </ul>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <?php
                                                                    $stmt = $conn->prepare("SELECT sp_ma, sp_ten, sanpham.tg_ma, tg_ten, sanpham.nxb_ma, nxb_ten, sanpham.nn_ma, nn_ten, sanpham.tl_ma, tl_ten, sp_kichthuoc, sp_sotrang, sp_hinhthuc, sp_gia, sp_soluongtonkho, sp_mota, sp_hinhanh, sp_giamgia FROM sanpham "
                                                                            . "JOIN tacgia ON tacgia.tg_ma = sanpham.tg_ma "
                                                                            . "JOIN nhaxuatban ON nhaxuatban.nxb_ma = sanpham.nxb_ma "
                                                                            . "JOIN ngonngu ON ngonngu.nn_ma = sanpham.nn_ma "
                                                                            . "JOIN theloai ON theloai.tl_ma = sanpham.tl_ma WHERE sp_ma = $idpro");
                                                                    $stmt->execute();
                                                                    $result = $stmt->get_result()->fetch_assoc();
                                                                    ?>
                                                                    <input name="idpro" type="number" class="form-control" value="<?php echo $result['sp_ma'] ?>" readonly="">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="namepro" type="text" class="form-control" placeholder="Tên sản phẩm" value="<?php echo $result['sp_ten'] ?>">
                                                                    <?php
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="author" class="form-control">
                                                                        <option value="<?php echo $result['tg_ma'] ?>"><?php echo $result['tg_ten'] ?></option>
                                                                        <?php
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="publishing" class="form-control">
                                                                        <option value="<?php echo $result['nxb_ma'] ?>"><?php echo $result['nxb_ten'] ?></option>
                                                                        <?php
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="language" class="form-control">
                                                                        <option value="<?php echo $result['nn_ma'] ?>"><?php echo $result['nn_ten'] ?></option>
                                                                        <?php
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="category" class="form-control">
                                                                        <option value="<?php echo $result['tl_ma'] ?>"><?php echo $result['tl_ten'] ?></option>
                                                                        <?php
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="size" type="text" class="form-control" placeholder="Kích thước (ví dụ: 12 x 15)" value="<?php echo $result['sp_kichthuoc'] ?>">
                                                                    <?php
                                                                    if (isset($_POST['update'])) {
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="pagenum" type="number" class="form-control" placeholder="Số trang" value="<?php echo $result['sp_sotrang'] ?>">
                                                                    <?php
                                                                    if (isset($_POST['update'])) {
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <select name="form" class="form-control">
                                                                        <?php
                                                                        if ($result['sp_hinhthuc'] == "Bìa mềm") {
                                                                            ?>
                                                                            <option value="<?php echo $result['sp_hinhthuc'] ?>"><?php echo $result['sp_hinhthuc'] ?></option>
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="price" type="number" class="form-control" placeholder="Giá" value="<?php echo $result['sp_gia'] ?>">
                                                                    <?php
                                                                    if (isset($_POST['update'])) {
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="quantity" type="number" class="form-control" placeholder="Số lượng" value="<?php echo $result['sp_soluongtonkho'] ?>">
                                                                    <?php
                                                                    if (isset($_POST['update'])) {
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea name="description" class="form-control" placeholder="Mô tả"><?php echo $result['sp_mota'] ?></textarea>
                                                                    <?php
                                                                    if (isset($_POST['update'])) {
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="discount" type="number" class="form-control" placeholder="Giảm giá (ví dụ: 10)" value="<?php echo $result['sp_giamgia'] ?>">
                                                                    <?php
                                                                    if (isset($_POST['update'])) {
                                                                        $discount = trim($_POST['discount']);
                                                                        $sql = "UPDATE sanpham SET sp_ten = '$product', tg_ma = $author, nxb_ma = $publishing, nn_ma = $language,"
                                                                                . " tl_ma = $category, sp_kichthuoc = '$size', sp_sotrang = $pagenum, sp_hinhthuc = '$form', sp_gia = $price,"
                                                                                . " sp_soluongtonkho = $quantity, sp_mota = '$des', sp_giamgia = $discount WHERE sp_ma = $idpro";
                                                                        if ($conn->query($sql)) {
                                                                            ?>
                                                                            ...
                                                                            ?>
                                                                            <span>Cập nhật sản phẩm thất bại.</span>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
