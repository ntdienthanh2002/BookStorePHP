                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Thêm thể loại</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <input name="nameca" type="text" class="form-control" placeholder="Tên thể loại">
                                                                        <?php
                                                                        if (isset($_POST['add'])) {
                                                                            ...
                                                                            if ($category != "") {
                                                                                ...
                                                                                if ($result->num_rows > 0) {
                                                                                    ...
                                                                                    $sql = "INSERT INTO theloai (tl_ten) VALUES ('$category')";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Thêm thể loại mới thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Thêm thể loại mới thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
