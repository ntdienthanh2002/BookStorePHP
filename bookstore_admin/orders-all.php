                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th data-field="id">Mã đơn hàng</th>
                                                    <th data-field="iduser">Mã tài khoản</th>
                                                    <th data-field="dateorder">Ngày đặt hàng</th>
                                                    <th data-field="datedeli">Ngày giao hàng</th>
                                                    <th data-field="addr">Địa chỉ giao hàng</th>
                                                    <th data-field="phone">Số điện thoại giao hàng</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['dh_ngaygiaohang'] ?></td>
                                                        <td><?php echo $row['dh_diachigiaohang'] ?></td>
                                                        <td><?php echo $row['dh_sdtgiaohang'] ?></td>
                                                        <td><?php echo $row['dh_ghichu'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
