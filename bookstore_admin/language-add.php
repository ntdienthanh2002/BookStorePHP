                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Thêm ngôn ngữ</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <input name="namela" type="text" class="form-control" placeholder="Ngôn ngữ (ví dụ: Tiếng Việt)">
                                                                        <?php
                                                                        if (isset($_POST['add'])) {
                                                                            ...
                                                                            if ($language != "") {
                                                                                ...
                                                                                if ($result->num_rows > 0) {
                                                                                    ...
                                                                                    $sql = "INSERT INTO ngonngu (nn_ten) VALUES ('$language')";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Thêm ngôn ngữ mới thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Thêm ngôn ngữ mới thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
