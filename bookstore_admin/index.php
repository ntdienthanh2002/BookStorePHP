                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th data-field="state"><i class="fa fa-trash-o"></i></th>
                                                    <th data-field="state2"><i class="fa fa-edit"></i></th>
                                                    <th data-field="id">Mã</th>
                                                    <th data-field="name">Tên</th>
                                                    <th data-field="author">Mã tác giả</th>
                                                    <th data-field="publishing">Mã NXB</th>
                                                    <th data-field="language">Mã ngôn ngữ</th>
                                                    <th data-field="category">Mã thể loại</th>
                                                    <th data-field="size">Kích thước</th>
                                                    <th data-field="pagenum">Số trang</th>
                                                    <th data-field="form">Hình thức</th>
                                                    <th data-field="price">Giá</th>
                                                    <th data-field="quantity">Số lượng</th>
                                                    <th data-field="description">Mô tả</th>
                                                    <th data-field="discount">Giảm giá</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $product = new Sanpham("", "");
                                                $result = $product->showAllProducts($conn);
                                                while ($row = $result->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td><a href="product-remove.php?action=remove&id=<?php echo $row['sp_ma'] ?>"><i class="fa fa-trash-o"></i></a></td>
                                                        <td><a href="product-update.php?action=update&idpro=<?php echo $row['sp_ma'] ?>"><i class="fa fa-edit"></i></a></td>
                                                        <td><?php echo $row['sp_ma'] ?></td>
                                                        <td><?php echo $row['sp_ten'] ?></td>
                                                        <td><?php echo $row['tg_ma'] ?></td>
                                                        <td><?php echo $row['nxb_ma'] ?></td>
                                                        <td><?php echo $row['nn_ma'] ?></td>
                                                        <td><?php echo $row['tl_ma'] ?></td>
                                                        <td><?php echo $row['sp_kichthuoc'] ?> cm</td>
                                                        <td><?php echo $row['sp_sotrang'] ?></td>
                                                        <td><?php echo $row['sp_hinhthuc'] ?></td>
                                                        <td><?php echo $row['sp_gia'] ?> VNĐ</td>
                                                        <td><?php echo $row['sp_soluongtonkho'] ?></td>
