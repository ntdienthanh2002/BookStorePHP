                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Cập nhật ngôn ngữ</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <?php
                                                                        $stmt = $conn->prepare("SELECT nn_ma, nn_ten FROM ngonngu WHERE nn_ma = $idla");
                                                                        $stmt->execute();
                                                                        $result = $stmt->get_result()->fetch_assoc();
                                                                        ?>
                                                                        <input name="idla" type="number" class="form-control" value="<?php echo $result['nn_ma'] ?>" readonly="">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <input name="namela" type="text" class="form-control" placeholder="Ngôn ngữ (ví dụ: Tiếng Việt)" value="<?php echo $result['nn_ten'] ?>">
                                                                        <?php
                                                                        if (isset($_POST['update'])) {
                                                                            $language = trim($_POST['namela']);
                                                                            if ($language != "") {
                                                                                $stmt = $conn->prepare("SELECT nn_ten FROM ngonngu WHERE nn_ten = '$language'");
                                                                                $stmt->execute();
                                                                                $result = $stmt->get_result();
                                                                                if ($result->num_rows > 0) {
                                                                                    ?>
                                                                                    <span>Ngôn ngữ đã tồn tại.</span>
                                                                                    <?php
                                                                                } else {
                                                                                    $sql = "UPDATE ngonngu SET nn_ten = '$language' WHERE nn_ma = $idla";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Cập nhật ngôn ngữ thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Cập nhật ngôn ngữ thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
                                                                                ?>
                                                                                <span>Vui lòng nhập ngôn ngữ.</span>
                                                                                <?php
                                                                            }
                                                                        }
                                                                        ?>
