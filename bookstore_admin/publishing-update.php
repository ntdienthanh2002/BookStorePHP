                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Cập nhật nhà xuất bản</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <?php
                                                                        $stmt = $conn->prepare("SELECT nxb_ma, nxb_ten FROM nhaxuatban WHERE nxb_ma = $idpu");
                                                                        $stmt->execute();
                                                                        $result = $stmt->get_result()->fetch_assoc();
                                                                        ?>
                                                                        <input name="idpu" type="number" class="form-control" value="<?php echo $result['nxb_ma'] ?>" readonly="">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <input name="namepu" type="text" class="form-control" placeholder="Tên nhà xuất bản" value="<?php echo $result['nxb_ten'] ?>">
                                                                        <?php
                                                                        if (isset($_POST['update'])) {
                                                                            $publishing = trim($_POST['namepu']);
                                                                            if ($publishing != "") {
                                                                                $stmt = $conn->prepare("SELECT nxb_ten FROM nhaxuatban WHERE nxb_ten = '$publishing'");
                                                                                $stmt->execute();
                                                                                $result = $stmt->get_result();
                                                                                if ($result->num_rows > 0) {
                                                                                    ?>
                                                                                    <span>Nhà xuất bản đã tồn tại.</span>
                                                                                    <?php
                                                                                } else {
                                                                                    $sql = "UPDATE nhaxuatban SET nxb_ten = '$publishing' WHERE nxb_ma = $idpu";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Cập nhật nhà xuất bản thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Cập nhật nhà xuất bản thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
                                                                                ?>
                                                                                <span>Vui lòng nhập tên nhà xuất bản.</span>
                                                                                <?php
                                                                            }
                                                                        }
                                                                        ?>
