                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active"><a href="">Cập nhật thể loại</a></li>
                                </ul>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    <div class="form-group">
                                                                        <?php
                                                                        $stmt = $conn->prepare("SELECT tl_ma, tl_ten FROM theloai WHERE tl_ma = $idca");
                                                                        $stmt->execute();
                                                                        $result = $stmt->get_result()->fetch_assoc();
                                                                        ?>
                                                                        <input name="idca" type="number" class="form-control" value="<?php echo $result['tl_ma'] ?>" readonly="">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <input name="nameca" type="text" class="form-control" placeholder="Thể loại" value="<?php echo $result['tl_ten'] ?>">
                                                                        <?php
                                                                        if (isset($_POST['update'])) {
                                                                            $category = trim($_POST['nameca']);
                                                                            if ($category != "") {
                                                                                $stmt = $conn->prepare("SELECT tl_ten FROM theloai WHERE tl_ten = '$category'");
                                                                                $stmt->execute();
                                                                                $result = $stmt->get_result();
                                                                                if ($result->num_rows > 0) {
                                                                                    ?>
                                                                                    <span>Thể loại đã tồn tại.</span>
                                                                                    <?php
                                                                                } else {
                                                                                    $sql = "UPDATE theloai SET tl_ten = '$category' WHERE tl_ma = $idca";
                                                                                    if ($conn->query($sql)) {
                                                                                        ?>
                                                                                        <span>Cập nhật thể loại thành công.</span>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <span>Cập nhật thể loại thất bại.</span>
                                                                                        <?php
                                                                                    }
                                                                                }
                                                                            } else {
                                                                                ?>
                                                                                <span>Vui lòng nhập thể loại.</span>
                                                                                <?php
                                                                            }
                                                                        }
                                                                        ?>
