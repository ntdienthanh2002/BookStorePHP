                                        ...
                                        <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name">Tên ngôn ngữ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td><a href="language-update.php?action=update&idla=<?php echo $row['nn_ma'] ?>"><i class="fa fa-edit"></i></a></td>
                                                        <td><?php echo $row['nn_ma'] ?></td>
                                                        <td><?php echo $row['nn_ten'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
